...
from a2a_research.backend.agents.pydantic_ai.synthesizer.artifacts import (
    enqueue_report_artifacts,
)
from a2a_research.backend.agents.pydantic_ai.synthesizer.card import (
    SYNTHESIZER_CARD,
)
from a2a_research.backend.agents.pydantic_ai.synthesizer.core import synthesize
from a2a_research.backend.agents.pydantic_ai.synthesizer.payload import (
    _coerce_claims,
    _coerce_sources,
    _extract_payload,
)
...
from a2a_research.backend.core.models import AgentRole, ReportOutput
