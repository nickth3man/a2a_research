...
export function EmptyState() {
  const query = useTyping(
    "What are the main differences between A2A and MCP?",
    32,
    500,
  );
  ...
  return (
    ...
    >
      ...
      <div style={{ position: "relative", zIndex: 1, maxWidth: 680 }}>
        ...
        >
          Twelve specialist agents will retrieve passages from the local corpus,
          cross-verify every claim, and return a report with inline citations.
        </p>
