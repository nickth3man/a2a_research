...
from core.progress import Bus
from core.settings import settings
from core.telemetry import configure_telemetry
from entrypoints.agent_mounts import mount_agents
from entrypoints.api_models import (
    ResearchRequest,
    ResearchResponse,
)
from entrypoints.session_manager import (
    get_session_task,
...
async def start_research(
    ...
    from core import ResearchSession
    from workflow.definitions import STEP_INDEX
    ...
    async def _run() -> ResearchSession:
        import core.a2a as _a2a
        from core import BudgetConsumption
        from workflow.definitions import (
            budget_from_settings,
        )
        from workflow.engine import drive
