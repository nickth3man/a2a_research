...
from agents.smolagents.searcher.prompt import (
    SEARCHER_PROMPT,
)
from agents.smolagents.searcher.tools import WebSearchTool
from core import AgentRole, emit_tool_call, settings
