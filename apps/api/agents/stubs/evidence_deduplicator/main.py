...
from agents.stubs.evidence_deduplicator.card import (
    EVIDENCE_DEDUPLICATOR_CARD,
)
from agents.stubs.evidence_deduplicator.normalize import (
    normalize_pages_to_evidence,
)
from agents.stubs.evidence_deduplicator.payload import (
    _extract_payload,
)
from core import (
    AgentRole,
